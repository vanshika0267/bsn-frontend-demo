...
export async function fetchGitHubRepos(username: string, sort: 'updated' | 'pushed' | 'full_name' = 'updated'): Promise<GitHubRepo[]> {
...
export function getSavedGitHubUsername(): string | null {
  try {
...
export function getSyncMeta(): GitHubSyncMeta | null {
  try {
...
export function saveSyncMeta(meta: GitHubSyncMeta) {
  try {
