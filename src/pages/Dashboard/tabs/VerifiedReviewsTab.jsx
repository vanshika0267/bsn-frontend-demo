      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            {programs.length === 0 ? (
              <p className="text-xs text-on-surface-variant font-medium p-4 bg-white rounded-xl border border-outline-variant">No programs or reviews available yet.</p>
            ) : (
              programs.map(prog => {
          ...
          {selectedProgram ? (
            <Card className="bg-white p-5 space-y-4">
              ...
              <div className="space-y-4 pt-1">
                {selectedProgram.reviews && selectedProgram.reviews.length > 0 ? (
                  ...
                  <p className="text-xs text-on-surface-variant font-medium py-4">No reviews written for this program yet.</p>
                )}
              </div>

            </Card>
          ) : (
            <Card className="bg-white p-8 text-center text-xs text-on-surface-variant font-medium">
              No review program selected. Select a program or check back later.
            </Card>
          )}
        </div>
